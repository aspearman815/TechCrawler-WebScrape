...
public class TechWebCrawler implements Runnable {
    ...
    private final ArrayList<String> visitedLink = new ArrayList<String>();
    private final ArrayList<TechArticles> articlesList = new ArrayList<>();
    ...
    // crawler based on depth level and makes sure to not visit the same link twice
    ...
    public static void writeDataToCSV(List<TechArticles> articlesList) {
        ...
        try (CSVWriter csvWrite = new CSVWriter(new FileWriter(csvFileName))) {
            ...
            for (TechArticles article : articlesList) {
                ...
                // starts a new line for each URL
